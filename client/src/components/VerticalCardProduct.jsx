        ...
        {loading
          ? loadingList.map((product, index) => {
              return (
                <div className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow" key={index}>
                  <div className="bg-slate-200 h-48 p-4 min-w-[280px] md:min-w-[145px] cursor-pointer flex justify-center items-center animate-pulse"></div>
                  <div className="p-4 grid gap-3 w-full animate-pulse">
                    <h2 className="font-medium text-base md:text-lg text-ellipsis line-clamp-1 bg-slate-200 text-black p-1 w-full">
                      {" "}
                    </h2>
                    <p className="capitalize text-slate-500 p-1 w-full bg-slate-200">
                      {" "}
                    </p>
                    ...
                    <button className="text-sm bg-slate-200  text-white px-3 py-0.5 rounded-full"></button>
                  </div>
                </div>
              );
            })
          : data.map((product, index) => {
              return (
                ...
                >
                  <div className="bg-slate-200 h-48 p-4 min-w-[280px] md:min-w-[145px] cursor-pointer flex justify-center items-center">
                    <img
